  ...
  head: () => ({
    meta: [
      ...
      { title: "Luce by Lucia — Admin" },
      {
        name: "description",
        content:
          "The internal operating system for Luce by Lucia: products, orders, inventory, collections and homepage content.",
      },
      { name: "author", content: "Luce by Lucia" },
      { property: "og:title", content: "Luce by Lucia — Admin" },
      {
        property: "og:description",
        content: "Premium womenswear commerce operations, designed in Nairobi.",
      },
